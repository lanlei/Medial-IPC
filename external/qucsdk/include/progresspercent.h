...
/**
 * 百分比进度条控件 作者:feiyangqingyun(QQ:517216493) 2017-8-22
 * 1:可设置范围值,支持负数值
 * 2:可设置起始点度数
 * 3:可设置顺时针逆时针
 * 4:可设置进度条或者线条宽度
 ...
 * 10:提供五种样式风格选择 圆弧风格 水池风格 波纹风格 圆弧水池风格 圆弧波纹风格
 */
...
class QDESIGNER_WIDGET_EXPORT ProgressPercent : public QWidget
#else
