#pragma once
#ifndef NEOHOOKEAN_ISOTROPIC_MATERIAL_H
#define NEOHOOKEAN_ISOTROPIC_MATERIAL_H
...
class NeoHookeanIsotropicMaterial : public IsotropicMaterialWithCompressionResistance
	{
	public:
		NeoHookeanIsotropicMaterial(BaseTetMeshHandle* tetHandle, int enableCompressionResistance = 0, qeal compressionResistance = 0.0);
...
#endif // !NEOHOOKEAN_ISOTROPIC_MATERIAL_H
